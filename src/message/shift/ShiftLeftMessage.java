...
public class ShiftLeftMessage extends ProtocolMessage {
    private int chunkNum;
    private int repDegree;
    private byte[] body;

    public ShiftLeftMessage(String senderId, String fileId, String chunkNum, String repDegree, byte[] body) {
        super("SHIFT_LEFT", senderId, fileId);
        this.chunkNum = Integer.parseInt(chunkNum);
        this.repDegree = Integer.parseInt(repDegree);
        this.body = body;
    }

    public ShiftLeftMessage(long senderId, String fileId, int chunkNum, int repDegree, byte[] body) {
        super("SHIFT_LEFT", senderId, fileId);
